...
namespace Microsoft.Samples.Kinect.AudioBasics
{
  ...
  //  using framework2;
    ...
    //    private AudioCreate test2;
        ...
        //    test2.ReciveAudio(10, 50, 16, 2, 40, 780, 195);
            ...
            while (this.reading)
            {
                ...
                lock (this.energyLock)
                {
                    for (int i = 0; i < readCount; i += 2)
                    {
                        ...
                        Console.WriteLine(" energy " + energy[this.energyIndex]);
                        Console.WriteLine(" beenangle " +  this.sensor.AudioSource.BeamAngle );
                        Console.WriteLine(" SourceAngle " + this.sensor.AudioSource.SoundSourceAngle);
                        Console.WriteLine(" SourceangleConfidance " + this.sensor.AudioSource.SoundSourceAngleConfidence);
                        Console.WriteLine(" anglemode " + this.sensor.AudioSource.BeamAngleMode);
